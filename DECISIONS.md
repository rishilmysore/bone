...
| 2026-07-05 | lint.sh rule 2 gates only plan-shaped files (has ## Verify or ## Tasks); non-plan provenance docs archive ungated — approved divergence from vendored marrow v0.2.0, candidate upstream diff | human disposition 2026-07-05 (scope the lint, not the doc); plans/archive/lint-rule2-plans-only.md: new case red on unpatched lint (26 ok/1 BAD) → 27/0 green |
